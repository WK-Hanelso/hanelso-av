...
`torch` import 금지 — 파싱 전용 경량 env와 추론 env 양쪽에서 import될 수 있어야 한다.
...
파싱 드라이버(docker 단일 환경): `python3 parse_clip.py configs/e100bt25.py`,
`python3 parse_map.py --map <base_map.bin> --name AYG`.
